...
import com.github.abdalimran.tourmate.Interfaces.Weather_API_Interface;
import com.github.abdalimran.tourmate.Models.GPSTracker;
import com.github.abdalimran.tourmate.Models.TimeDate;
...
public class WeatherUpdates extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weatherupdates);
    ...
    private void getWeatherConditions(String currentCity)
    {
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        Weather_API_Interface weatherService = retrofit.create(Weather_API_Interface.class);
        Call<ConditionResponse> callWeatherConditions = weatherService.getWeatherConditions(Constants.API_KEY_WEATHER,currentCity);
    ...
    private void getForecast10day(String currentCity)
    {
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        Weather_API_Interface weatherService = retrofit.create(Weather_API_Interface.class);
        Call<Forecast10dayResponse>callWeatherForecast = weatherService.getWeatherForecast(Constants.API_KEY_WEATHER,currentCity);
    ...
    private void getWeatherData()
    {
        ...
        Weather_API_Interface weatherService = retrofit.create(Weather_API_Interface.class);
        Call<GeolookupResponse> callGeolookup = weatherService.getGeolookup(Constants.API_KEY_WEATHER,gps.getLatitude(),gps.getLongitude());
